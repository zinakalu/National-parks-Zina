"""Create tables users, visits, parks

Revision ID: 5ba74d7fd0d4
Revises: 
Create Date: 2023-07-18 07:50:09.605458
...
def upgrade():
    ...
    sa.Column('campgrounds', sa.String(), nullable=True),
